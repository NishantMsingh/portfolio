...
const Work = () => {
  ...
  <div class=" max-w work-card col-lg-3 col-md-4 col-sm-6 ms-1 me-1 text-light mt-3 d-flex flex-column align-items-center justify-content-center border-0 pt-5 pb-5 rounded">
